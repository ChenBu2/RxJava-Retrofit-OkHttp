...
public class PreferenceUtils {
    ...
    public static void putJsessionId(String value){
        SharedPreferences sp = HongTaiApp.getContext().getSharedPreferences(
    ...
    public static boolean isEmpty(String key){
        return TextUtils.isEmpty(PreferenceUtils.getPrefString(HongTaiApp.getContext(), key, ""));
    }

    public static <T> T getClaz(String key, Type type){
        try{
            String prefString = PreferenceUtils.getPrefString(HongTaiApp.getContext(), key, "");
