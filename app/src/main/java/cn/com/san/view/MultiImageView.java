...
import cn.com.san.R;
import cn.com.san.manager.ImageOption;
...
public class MultiImageView extends LinearLayout {
    ...
    private ImageView createImageView(int position, final boolean isMultiImage) {
        ...
        if (isMultiImage) {
            ...
            int expectW = getWidth(photoInfo);
            int expectH = getHeight(photoInfo);
        ...
        ImageLoader.getInstance().displayImage(photoInfo, imageView, ImageOption.defaultOptions);
