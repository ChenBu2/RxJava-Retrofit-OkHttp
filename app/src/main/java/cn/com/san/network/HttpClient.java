...
import cn.com.san.utils.CookieUtil;
import cn.com.san.utils.LogUtils;
import cn.com.san.utils.NetUtil;
import cn.com.san.utils.UserAgentUtils;
    ...
    public static void initOkHttpClient() {
        if (mOkHttpClient == null) {
            synchronized (HttpClient.class) {
                ...
                // 指定缓存路径,缓存大小100Mb
                Cache cache = new Cache(new File(HongTaiApp.getContext().getCacheDir(), "MenJin"),
                        1024 * 1024 * 100);
